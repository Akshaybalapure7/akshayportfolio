  ...
  return (
     <section className="relative w-full h-screen mx-auto">
          <div className={`${styles.paddingX} absolute inset-0 top-[120px] 
                            max-w-7xl mx-auto flex flex-row flex-wrap items-start gap-5 
                         `}>
              ...
              <div className="flex place-content-center  sm:w-[220px] w-[24rem] float-right " style={{clipPath:`polygon(100% 0, 85% 49%, 100% 100%, 24% 100%, 0% 50%, 23% 0)` , marginLeft:"auto"}}>
